...
def get_london_level_1_1():
    return [
        ...
        Passenger(id=4, name="Anastasiya", is_child=True, prefers_forward=True, wants_to_be_near_child=True),
        Passenger(id=5, name="Li", must_be_near=[1], is_child=True),
        Passenger(id=6, name="Harper", wants_to_be_alone=True, hates_bad_smells=True, hates_cologne=True),
...
def get_london_level_1_3():
    return [
        ...
        Passenger(id=5, name="David", plays_music=True, smells_bad=True, hates_talkative=True),
