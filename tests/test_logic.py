...
def test_talkative_inclusion_logic():
    seats = [
        Seat(
            id="S1", x=0, y=0, position=Position.MIDDLE, orientation=Orientation.FORWARD
        ),
        Seat(
            id="S2", x=1, y=0, position=Position.MIDDLE, orientation=Orientation.FORWARD
        ),
        Seat(
            id="S3", x=5, y=5, position=Position.MIDDLE, orientation=Orientation.FORWARD
        ),
    ]
